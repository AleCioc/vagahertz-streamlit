...
st.markdown("Benvenut* nella pagina di registrazione e tesseramento digitale di VagaHertz!")

st.markdown("Compilando il form sottostante otterrai una tessera digitale VagaHertz per l'anno 2024.")
        ...
        if submitted:
            ...
            if trattamento_dati_check and statuto_check:
                ...
                if not os.path.exists(user_unique_json_path):
                    ...
                    st.title("Grazie per la registrazione!")
                    st.session_state["user_info_dict"] = None
